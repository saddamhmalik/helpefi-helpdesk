...
use Illuminate\Support\Facades\Route;
    ...
    Route::middleware('agent')->group(function () {
        ...
        Route::delete('/settings/members/{member}', [MemberController::class, 'destroy'])->name('settings.members.destroy');
            ...
            Route::put('/settings/brands/{brand}', [BrandController::class, 'update'])->name('settings.brands.update')->whereNumber('brand');
            Route::delete('/settings/brands/{brand}', [BrandController::class, 'destroy'])->name('settings.brands.destroy')->whereNumber('brand');
