...
Route::middleware([
    ...
    Route::get('/openapi.json', [OpenApiController::class, 'spec'])->middleware('throttle:30,1');
    ...
    Route::prefix('portal/{brand:slug}')->middleware(['brand', 'portal.locale'])->group(function () {
        ...
        Route::post('/tickets/track', [ApiPortalController::class, 'track'])->middleware('throttle:10,1');
        Route::post('/auth/register', [ApiPortalAuthController::class, 'register'])->middleware('throttle:5,1');
        Route::post('/auth/login', [ApiPortalAuthController::class, 'login'])->middleware('throttle:5,1');
    ...
    Route::middleware(['api.token', 'api.customer'])->group(function () {
    ...
    Route::middleware(['api.token', 'api.agent', 'subscription.active'])->group(function () {
        Route::middleware(['api.admin', 'permission:settings.roles'])->group(function () {
        ...
        Route::middleware('permission:tickets.view')->group(function () {
            ...
            Route::get('/tickets/{ticket}/panels', [ApiTicketController::class, 'panels']);
        ...
        Route::middleware(['api.admin', 'permission:settings.sla'])->group(function () {
        ...
        Route::middleware(['api.admin', 'permission:settings.service-desk'])->group(function () {
        ...
        Route::get('/search', ApiGlobalSearchController::class)->middleware('permission:tickets.view');

        Route::middleware('permission:workspace.use')->group(function () {
            ...
            Route::get('/workspace/tickets/{ticket}/realtime-token', [ApiWorkspaceController::class, 'realtimeToken']);
        ...
        Route::middleware(['api.admin', 'permission:settings.channels'])->group(function () {
        ...
        Route::middleware(['api.admin', 'permission:settings.automation'])->group(function () {
        ...
        Route::middleware(['api.admin', 'permission:settings.integrations'])->group(function () {
        ...
        Route::middleware(['api.admin', 'permission:settings.ai'])->group(function () {
        ...
        Route::middleware(['api.admin', 'permission:settings.service-catalog'])->group(function () {
        ...
        Route::middleware('permission:settings.billing')->group(function () {
            Route::get('/billing', [ApiBillingController::class, 'show']);
            Route::put('/billing/plan', [ApiBillingController::class, 'updatePlan']);
        });

        Route::middleware(['api.admin', 'permission:settings.security'])->group(function () {
        ...
        Route::get('/security/audit-logs', [ApiSecurityController::class, 'auditLogs'])->middleware('audit.view');
        ...
        Route::middleware(['api.admin', 'permission:settings.notifications'])->group(function () {
        ...
        Route::middleware(['api.admin', 'permission:settings.csat'])->group(function () {
