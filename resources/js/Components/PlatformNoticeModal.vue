...
const styles = {
    maintenance: {
        ...
        badge: 'bg-amber-200/60 dark:bg-amber-900/50 text-amber-900 dark:text-amber-200',
    ...
    offer: {
        ...
        badge: 'bg-emerald-200/60 dark:bg-emerald-900/50 text-emerald-900 dark:text-emerald-200',
        title: 'text-slate-900 dark:text-slate-100',
    ...
    announcement: {
        ...
        badge: 'bg-blue-200/60 dark:bg-blue-900/50 text-blue-900 dark:text-blue-200',
        title: 'text-slate-900 dark:text-slate-100',
