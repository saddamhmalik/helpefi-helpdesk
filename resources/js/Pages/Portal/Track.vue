...
const lookup = () => form.post('/portal/track');
</script>
...
<template>
    ...
    <PortalLayout>
        <div class="mx-auto max-w-xl">
            ...
            <h1 class="mt-2 text-2xl font-bold text-slate-900">Track your request</h1>
            <p class="mt-1 text-sm text-slate-600">Enter your ticket number and email to view status.</p>

            <form class="mt-6 space-y-4 rounded-xl border border-slate-200 bg-white p-6 shadow-sm" @submit.prevent="lookup">
                <div>
                    <label class="mb-1 block text-sm font-medium text-slate-700">Ticket number</label>
                ...
                <button type="submit" class="w-full rounded-lg bg-blue-600 px-4 py-2 font-medium text-white hover:bg-blue-700" :disabled="form.processing">Track</button>
            </form>
            ...
            <p class="mt-6 text-center text-sm text-slate-600">
                <Link href="/portal/login" class="text-blue-600 hover:text-blue-700">Sign in</Link>
                to see all your tickets, or
                <Link href="/portal/register" class="text-blue-600 hover:text-blue-700">create an account</Link>.
            </p>
        </div>
    </PortalLayout>
</template>
