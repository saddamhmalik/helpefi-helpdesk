        ...
        <div class="mx-auto max-w-2xl px-4 py-8 sm:px-6">
            ...
            <div class="space-y-6">
                <form class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm" @submit.prevent="saveProfile">
                    <h2 class="text-lg font-semibold text-slate-900">{{ $t('central.account') }}</h2>
                ...
                <form class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm" @submit.prevent="savePassword">
                    ...
                    <p class="mt-1 text-sm text-slate-500">{{ $t('central.choose_a_strong_password_for_your_platform_admin_account') }}</p>
                    <div class="mt-5 space-y-4">
                        <div>
                            <label class="mb-1.5 block text-sm font-medium text-slate-700">{{ $t('profile.current_password') }}</label>
                        ...
                        <div>
                            <label class="mb-1.5 block text-sm font-medium text-slate-700">{{ $t('profile.new_password') }}</label>
                        ...
                        <div>
                            <label class="mb-1.5 block text-sm font-medium text-slate-700">{{ $t('central.confirm_new_password') }}</label>
