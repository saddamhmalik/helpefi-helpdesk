        ...
        <div class="mx-auto max-w-2xl px-4 py-8 sm:px-6">
            ...
            <form class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm" @submit.prevent="submit">
                <div class="space-y-5">
                    ...
                    <div>
                        <label class="mb-1.5 block text-sm font-medium text-slate-700">{{ editing ? 'New password (optional)' : 'Password' }}</label>
                    ...
                    <div>
                        ...
                        <div class="grid gap-2 sm:grid-cols-2">
                            <label
                                ...
                                :class="form.roles.includes(role) ? 'border-blue-500 bg-blue-50 text-blue-900' : 'border-slate-200 text-slate-700 hover:border-slate-300'"
                            >
                                <input v-model="form.roles" type="checkbox" :value="role" class="rounded border-slate-300 text-blue-600" />
                                {{ formatRole(role) }}
                            </label>
                        </div>
