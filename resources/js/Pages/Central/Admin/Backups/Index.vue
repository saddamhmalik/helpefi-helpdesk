    ...
    <AdminLayout>
        ...
        <div v-if="can('backups.manage')" class="mb-6 rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            <div class="flex flex-wrap items-start justify-between gap-4">
                <div>
                    <h2 class="text-sm font-semibold text-slate-900">Automatic backups</h2>
                    <p class="mt-1 text-sm text-slate-500">
                        Queue central and workspace database snapshots on a schedule. Expired backups are purged automatically.
                    </p>
            ...
            <form class="mt-4 grid gap-4 md:grid-cols-4" @submit.prevent="saveSchedule">
                ...
                <div>
                    <label class="mb-1 block text-xs font-medium text-slate-500">Time</label>
                    <input
        ...
        <div v-if="can('backups.manage')" class="mb-6 grid gap-4 lg:grid-cols-3">
            <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                <h2 class="text-sm font-semibold text-slate-900">Central platform</h2>
                <p class="mt-1 text-sm text-slate-500">Backup tenants, subscriptions, payments, and platform settings.</p>
                <button
                    type="button"
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                <h2 class="text-sm font-semibold text-slate-900">All workspaces</h2>
                <p class="mt-1 text-sm text-slate-500">Queue a database snapshot for every customer workspace.</p>
                <button
                    type="button"
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                <h2 class="text-sm font-semibold text-slate-900">Single workspace</h2>
                <p class="mt-1 text-sm text-slate-500">Backup tickets, customers, and settings for one workspace.</p>
