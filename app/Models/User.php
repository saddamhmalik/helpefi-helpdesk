...
#[Fillable(['name', 'email', 'locale', 'timezone', 'appearance', 'avatar_type', 'avatar_path', 'password', 'api_token', 'contact_id', 'custom_fields', 'performance_score', 'two_factor_secret', 'two_factor_recovery_codes', 'two_factor_confirmed_at', 'sso_subject', 'sso_provider'])]
