...
class MigrateManagedToExternalDatabaseJob implements ShouldQueue
{
    use Queueable;
    ...
    public function handle(TenantInfrastructureMigrationService $migrations): void
    {
        ...
        $migrations->runDatabaseMigration($tenant);
    }
    ...
    public function failed(?Throwable $exception): void
    {
        ...
        if ($record === null || ! $record->hasPendingDatabaseMigration()) {
            return;
        }
